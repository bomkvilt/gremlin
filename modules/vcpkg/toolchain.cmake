## this file detects what triplet will be used
# NOTE: it's a downright copy-paste from vcpkg/scripts/buildsystem/vcpkg.cmake
# TODO: make a pull request to implement a static triplet detection
...
if(GN_cpp_static)
    set(_VCPKG_TARGET_TRIPLET_STATIC "-static")
else()
    set(_VCPKG_TARGET_TRIPLET_STATIC "")
endif()

set(VCPKG_TARGET_TRIPLET ${_VCPKG_TARGET_TRIPLET_ARCH}-${_VCPKG_TARGET_TRIPLET_PLAT}${_VCPKG_TARGET_TRIPLET_STATIC} CACHE STRING "Vcpkg target triplet (ex. x86-windows)" FORCE)

include("${GN_vcpkg_vcpkgTool}")
